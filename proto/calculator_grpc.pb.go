...
type CalculatorClient interface {
	...
	Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*OperationResponse, error)
	// Subtracts two numbers and returns the result.
	Subtract(ctx context.Context, in *SubtractRequest, opts ...grpc.CallOption) (*OperationResponse, error)
	// Multiplies two numbers and returns the result.
	Multiply(ctx context.Context, in *MultiplyRequest, opts ...grpc.CallOption) (*OperationResponse, error)
	// Divides two numbers and returns the result.
	Divide(ctx context.Context, in *DivideRequest, opts ...grpc.CallOption) (*OperationResponse, error)
}
...
func (c *calculatorClient) Add(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*OperationResponse, error) {
...
func (c *calculatorClient) Subtract(ctx context.Context, in *SubtractRequest, opts ...grpc.CallOption) (*OperationResponse, error) {
	out := new(OperationResponse)
...
func (c *calculatorClient) Multiply(ctx context.Context, in *MultiplyRequest, opts ...grpc.CallOption) (*OperationResponse, error) {
	out := new(OperationResponse)
...
func (c *calculatorClient) Divide(ctx context.Context, in *DivideRequest, opts ...grpc.CallOption) (*OperationResponse, error) {
	out := new(OperationResponse)
...
type CalculatorServer interface {
	// Adds two numbers and returns the result.
	Add(context.Context, *AddRequest) (*OperationResponse, error)
	// Subtracts two numbers and returns the result.
	Subtract(context.Context, *SubtractRequest) (*OperationResponse, error)
	// Multiplies two numbers and returns the result.
	Multiply(context.Context, *MultiplyRequest) (*OperationResponse, error)
	// Divides two numbers and returns the result.
	Divide(context.Context, *DivideRequest) (*OperationResponse, error)
...
func (UnimplementedCalculatorServer) Add(context.Context, *AddRequest) (*OperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Add not implemented")
}
func (UnimplementedCalculatorServer) Subtract(context.Context, *SubtractRequest) (*OperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Subtract not implemented")
}
func (UnimplementedCalculatorServer) Multiply(context.Context, *MultiplyRequest) (*OperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Multiply not implemented")
}
func (UnimplementedCalculatorServer) Divide(context.Context, *DivideRequest) (*OperationResponse, error) {
